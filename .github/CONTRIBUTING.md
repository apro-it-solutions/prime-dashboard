...
Thank you for considering contributing to **Prime**! Every contribution is valuable, whether it's reporting bugs, suggesting improvements, adding features, or refining README.
...
2. **Clone** your fork:
   ...
   ```bash
   git clone https://github.com/your-username/prime.git
   ```
...
Thank you for helping make **Prime** better! 🚀
